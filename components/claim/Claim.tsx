...
const Claim = () => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-oslo-gray/[0.22] rounded-[20px] flex flex-col items-center w-full max-w-[457px] mt-[75px] xl:mt-16 pt-[47px] pb-[50px] xl:pt-10 xl:pb-11">
