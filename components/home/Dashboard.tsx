  ...
  const [ecosystemApps] = useState<EcosystemApps>([
    {
      ...
      quests: [
        ...
        },
        {
          ...
          point: "12 points per $1 staked daily",
          unBoostedPoint: "8 points per $1 staked daily",
          description: "To multiply you points you need to take 2 simple steps:  \n**Step 1**\nBridge funds to the Fuse Network using Fuse bridge = 4 points per $1, available once per day.  \n**Step 2**\nDouble your points by staking bridged funds in a FUSE token liquid staking on Voltage DEX = 12 points per $1 of the bridged funds, available once per day.",
          isActive: true,
          isBoosted: true,
          button: "Go to Voltage",
          link: "https://app.voltage.finance/stake/sFUSE",
