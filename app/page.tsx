      ...
      <div className={`flex-col flex justify-start items-center bg-cover bg-no-repeat bg-bottom ${currentComponent === "landing" ? "h-screen" : "min-h-screen bg-[url('/vectors/grid.svg')]"}`}>
        {currentComponent === "landing" &&
          <div className="absolute w-full h-full z-0 min-h-[800px] bg-secondary overflow-hidden">
            ...
            <div className="absolute w-full h-full z-[3] min-h-[800px] overflow-hidden bg-[url('/vectors/bg-layer2.svg')] bg-no-repeat bg-[left_86%_bottom_calc((43vw-1400px)*0.08)] bg-80% animate-slide-in-bg-layer2 translate-y-1/2 md:bg-[left_86%_bottom_calc((50vw-275px)*0.08)]"></div>
            ...
            <div className="absolute w-full h-full z-[1] min-h-[800px] overflow-hidden bg-[url('/vectors/bg-layer4.svg')] bg-no-repeat bg-[center_bottom_calc(28vh*2.2-495px)] bg-contain max-w-[800px] left-[calc(50%-400px)] animate-slide-in-bg-layer4 translate-y-[60%] md:max-w-full md:left-0"></div>
